import GiddaaBuyCard from "./GiddaaBuyCard";
import GreenButton from "./shared/GreenButton";
import Image from "next/image";

const Hero = () => {
  return (
    <section className="relative mb-20 mt-32 flex justify-center px-4 py-8 md:px-6 lg:mb-32 lg:px-8">
      <div className="absolute right-[3%] top-[0.1%] hidden lg:block">
        <GiddaaBuyCard />
      </div>
      ...
      <div className="flex w-full max-w-[2000px] flex-col items-center gap-8 pt-5">
        ...
        <div className="flex flex-col items-center gap-3">
          <h1 className="w-[90%] text-center font-millik text-3xl font-bold leading-[40px] lg:w-[60%] lg:text-[3rem] lg:leading-[68px]">
