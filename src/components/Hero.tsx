...
const Hero = () => {
  return (
    <section className="mb-20 mt-32 flex justify-center px-4 py-8 md:px-6 lg:mb-32 lg:px-8">
      <div className="flex w-full max-w-[2000px] flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          <h1 className="w-[90%] text-center font-millik text-3xl font-bold leading-[40px] lg:w-2/3 lg:text-[3rem] lg:leading-[68px]">
